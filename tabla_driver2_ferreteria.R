...
driver2 <- data.frame(
  ...
  Justificacion = c(
    ...
    "21% son costos VARIABLES \u2014 crecen con los km recorridos",
...
tabla <- driver2 |>
  ...
  tab_source_note(
    source_note = md(
      "*Fuente: Estructura de costos internos \u2014 Ferreter\u00eda \u00b7 Driver 2: Costo Variable por km recorrido*"
    )
  ) |>
  tab_style(
...
gtsave(tabla, "tabla_driver2_ferreteria.html")
